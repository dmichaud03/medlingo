...
await  db.insert(schema.challenges).values([
    {
        ...
        type: "SELECT",
        order: 1,
        question: 'Identify the body structure.',
    },
]);
...
await  db.insert(schema.challengeOptions).values([
    ...
    },
    {
        ...
        challengeId: 1,
        type: "multiple choice",
        imageSrc: "/cardiovascularsystem.svg",
        correct: false,
    ...
    },
    {
        ...
        challengeId: 1,
        type: "multiple choice",
        imageSrc: "/respiratorysystem.svg",
        correct: false,
